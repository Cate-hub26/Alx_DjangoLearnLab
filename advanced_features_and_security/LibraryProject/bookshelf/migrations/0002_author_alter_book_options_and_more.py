    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(related_name='bookshelf_user_groups', to='auth.group')),
                ('user_permissions', models.ManyToManyField(related_name='bookshelf_user_permissions', to='auth.permission')),
            ],
            options={
                'verbose_name': 'user',
