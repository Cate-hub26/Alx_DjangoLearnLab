...
urlpatterns = [
    ...
    path('post/<int:pk>/comments/update/', CommentUpdateView.as_view(), name='comment-update'),
    path('post/<int:pk>/comments/delete/', CommentDeleteView.as_view(), name='comment-delete'),
]
